...
- Build a session terminal with more primary lines than the viewport.
...
None. The session-side mirror is the least dependency-heavy shippable route. The upstream `ScreenFormatter` selector remains a cleanup opportunity after this behavior is covered by tests.

## Design notes

- 2026-05-05T04:15Z - Picked session-side primary mirror over a libghostty fork for this pass.
