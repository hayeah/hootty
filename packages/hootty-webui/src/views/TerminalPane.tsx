import { TerminalPane as LibTerminalPane } from "@hayeah/hootty-termui";
...
// the padding + bg; @hayeah/hootty-termui's inner canvas host fills the
// space.
//
...
// wheel handler live inside @hayeah/hootty-termui's mountTerminal.
