import type { AttachStream } from "@hayeah/supervisor-termui";
import type { SessionSummary } from "./types";

// AttachStream is re-exported from @hayeah/supervisor-termui — the same byte-
// pipe contract both the mock and live data sources produce,
// consumed by @hayeah/supervisor-termui's TerminalPane.
