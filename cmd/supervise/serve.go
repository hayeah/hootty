...
//
// It is a fan-out / multiplexer over a state-dir of supervised
// sessions: each session has its own rpc.sock running the supervisor
...
//	DELETE /sessions/{key}            SIGTERM the supervisor by pid
