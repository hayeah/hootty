...
// Service is what the session runs. Consumers implement this.
//
// Run blocks until the service is done. Returning terminates the
// session process. The session owns infra (flock, state.json,
